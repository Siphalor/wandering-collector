<div align="center">
<img alt="Logo" src="./src/main/resources/assets/wandering_collector/icon.png" width="150" height="150" />
...
Of course, you can legitimately trade your items back only once (we don't talk about villager trade glitches ^^)
